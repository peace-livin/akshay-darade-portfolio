    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <div className="container mx-auto px-4 py-20">
            ...
            <div className="md:w-1/2 space-y-8">
              ...
              <div className="flex gap-6">
                ...
                <div className="flex items-center gap-4">
                  <a href=" https://github.com/peace-livin?tab=repositories" className="hover:text-blue-400 transition-colors">
                    <Github className="w-6 h-6" />
                  </a>
                  <a href="https://www.linkedin.com/in/akshay-darade-7893412b4?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" className="hover:text-blue-400 transition-colors">
                    <Linkedin className="w-6 h-6" />
                  </a>
                  <a href="mailto:akshaydarade54@gmail.com" className="hover:text-blue-400 transition-colors">
        ...
        <div className="mt-32">
          ...
          <div className="bg-gray-800 rounded-lg p-6 hover:shadow-xl transition-shadow">
            <h3 className="text-xl font-semibold text-blue-400">Bachelor of Engineering in Information Technology</h3>
            <p className="text-gray-300 mt-2">2022 - 2025</p>
      ...
      <footer className="bg-gray-900 mt-32 py-6">
        <div className="container mx-auto px-4 text-center text-gray-400">
          <p>© 2025 Akshay Darade. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
